...
public final class Native {
         ...
         if (!typeMappers.containsKey(interfaceClass)) {
            try {
               ...
               throw new IllegalArgumentException(
                  "TYPE_MAPPER must be a public field of type " + TypeMapper.class.getName() + " (" + var7 + "): " + interfaceClass
               );
            }
         }
   ...
   private static void loadNativeLibraryFromJar() {
      ...
      if (url == null) {
         throw new UnsatisfiedLinkError("JNA native support (" + resourceName + ") not found in resource path");
      } else {
         File lib = null;
   ...
   public static Library synchronizedLibrary(Library library) {
      ...
      if (!Proxy.isProxyClass(cls)) {
         ...
         if (!(ih instanceof Library.Handler)) {
            ...
            InvocationHandler newHandler = new Native$4(handler, library);
   ...
   public static String getWebStartLibraryPath(String libName) {
      if (System.getProperty("javawebstart.version") == null) {
         ...
         try {
            ...
            Method m = (Method)AccessController.doPrivileged(new Native$5());
   ...
   static void removeTemporaryFiles() {
      File dir = getTempDir();
      FilenameFilter filter = new Native$6();
   ...
   static Class getCallingClass() {
      Class[] context = new Native$7().getClassContext();
      if (context.length < 4) {
      ...
      if (mapper == null || mapper.getFromNativeConverter(type) == null && mapper.getToNativeConverter(type) == null) {
         if (Pointer.class.isAssignableFrom(type)) {
            ...
            if (type.isPrimitive()) {
               ...
               return NativeMapped.class.isAssignableFrom(type) ? 17 : -1;
            }
         }
      } else {
         return 21;
   ...
   public static void main(String[] args) {
      ...
      String DEFAULT_VERSION = "3.5.1";
      String DEFAULT_BUILD = "3.5.1 (package information missing)";
      ...
      String version = pkg != null ? pkg.getSpecificationVersion() : "3.5.1";
      if (version == null) {
         version = "3.5.1";
      }
      ...
      version = pkg != null ? pkg.getImplementationVersion() : "3.5.1 (package information missing)";
      if (version == null) {
         version = "3.5.1 (package information missing)";
      }
   ...
   static synchronized native long createNativeCallback(Callback var0, Method var1, Class[] var2, Class var3, int var4, int var5);
