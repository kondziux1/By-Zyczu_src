...
public class Synthetica2DUtils {
   ...
   public static BufferedImage createBluredImage(BufferedImage var0, int var1) {
   ...
   public static Image flipHorizontal(Image var0) {
      ...
      var2.scale(-1.0, 1.0);
      var2.translate(-var0.getWidth(null), 0);
   ...
   public static Image flipVertical(Image var0) {
      ...
      Graphics2D var2 = (Graphics2D)var1.getGraphics();
      var2.scale(1.0, -1.0);
      var2.translate(0, -var0.getHeight(null));
      var2.drawImage(var0, 0, 0, null);
      var2.dispose();
      return var1;
   }
