...
public class FileOperationDialog extends JDialog implements FileOperationListener, Runnable {
   ...
   private void init(Window var1, int var2) {
      ...
      JPanel var4 = new JPanel() {
         private Image background = new ImageIcon(SyntheticaLookAndFeel.class.getResource(FileOperationDialog.this.imagePath)).getImage();
         ...
         public void paintComponent(Graphics var1) {
            ImagePainter var2 = new ImagePainter(
               ...
               FileOperationDialog.this.imageInsets,
               FileOperationDialog.this.imageInsets
            );
            var2.draw();
