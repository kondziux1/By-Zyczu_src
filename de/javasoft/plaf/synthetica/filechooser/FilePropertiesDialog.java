...
public class FilePropertiesDialog extends JDialog implements FileOperationListener, Runnable {
   ...
   private void init(Window var1) {
      ...
      Image var16 = (Image)UIManager.get("Synthetica.filePropertiesDialog.iconImage");
      this.setTitle(this.title);
      this.setLayout(new BorderLayout());
      this.getRootPane().putClientProperty("Synthetica.dialog.iconImage", var16);
      JPanel var3 = new JPanel() {
         private Image background = new ImageIcon(SyntheticaLookAndFeel.class.getResource(FilePropertiesDialog.this.imagePath)).getImage();

         public void paintComponent(Graphics var1) {
            ImagePainter var2 = new ImagePainter(
               this.background,
               var1,
               0,
               0,
               ...
               FilePropertiesDialog.this.imageInsets,
               FilePropertiesDialog.this.imageInsets
            );
            var2.draw();
