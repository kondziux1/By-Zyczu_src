...
public class ScrollPaneStyle extends StyleWrapper {
   ...
   public static SynthStyle getStyle(SynthStyle var0, JComponent var1, Region var2) {
      String var3 = (String)SyntheticaLookAndFeel.get("Synthetica.scrollPane.layoutManager.className", var1);
   ...
   public Object get(SynthContext var1, Object var2) {
      ...
      return !JavaVersion.JAVA5
            && "ScrollPane.viewportBorderInsets".equals(var2)
            && UIManager.get(comboBoxViewportInsetsKey) != null
            && var3.getViewport().getView() != null
            && "ComboBox.list".equals(var3.getViewport().getView().getName())
         ? UIManager.getInsets(comboBoxViewportInsetsKey)
         : super.get(var1, var2);
   }
