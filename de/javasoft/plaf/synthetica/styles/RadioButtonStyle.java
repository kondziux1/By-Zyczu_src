...
public class RadioButtonStyle extends StyleWrapper {
   ...
   public static SynthStyle getStyle(SynthStyle var0, JComponent var1, Region var2) {
      if (SyntheticaLookAndFeel.getStyleName(var1) == null) {
         ...
         RadioButtonStyle var3 = new RadioButtonStyle();
         var3.setStyle(var0);
         return var3;
      }
   }
   ...
   public Icon getIcon(SynthContext var1, Object var2) {
      ...
      if (var3.getIcon() != null) {
         ...
         Object var7 = null;
         if ((var4 & 4) > 0) {
            boolean var8 = SyntheticaLookAndFeel.getBoolean("Synthetica.radioButton.emulatedPressedState.enabled", var3);
            boolean var9 = var3.isSelected();
            if (var8) {
               var7 = SyntheticaLookAndFeel.loadIcon(var9 ? "Synthetica.radioButton.selected.image" : "Synthetica.radioButton.image");
            }
            ...
            if (var8) {
               BufferedImage var10 = (BufferedImage)GraphicsUtils.iconToImage(var1, (Icon)var7);
               Color var11 = SyntheticaLookAndFeel.getColor(
                  "Synthetica.radioButton.emulatedPressedState.color", var3, UIManager.getColor("Panel.background").darker()
               );
               float var12 = (float)SyntheticaLookAndFeel.getInt("Synthetica.radioButton.emulatedPressedState.alpha", var3, 25) / 100.0F;
         ...
         if (var3.getClientProperty("Synthetica.background") != null) {
            float var14 = var3.getClientProperty("Synthetica.background.alpha") == null ? 0.1F : var3.getClientProperty("Synthetica.background.alpha");
            BufferedImage var15 = (BufferedImage)GraphicsUtils.iconToImage(var1, (Icon)var7);
            BufferedImage var16 = Synthetica2DUtils.createColorizedImage(var15, (Color)var3.getClientProperty("Synthetica.background"), var14);
            var7 = new ImageIcon(var16);
         }
