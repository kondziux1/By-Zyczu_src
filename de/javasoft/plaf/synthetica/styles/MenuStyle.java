...
public class MenuStyle extends StyleWrapper {
   ...
   public Font getFont(SynthContext var1) {
      ...
      Object var4 = SyntheticaLookAndFeel.get("Synthetica.menu.toplevel.fontSize", var3);
   ...
   public Color getColor(SynthContext var1, ColorType var2) {
      ...
      if (var3.isTopLevelMenu() && var2.equals(ColorType.TEXT_FOREGROUND)) {
         ...
         if (!var9.isActive()
            && SyntheticaLookAndFeel.getBoolean("Synthetica.window.decoration", var9)
            && SyntheticaLookAndFeel.get(var8 + ".inactive", var9) != null) {
            var8 = var8 + ".inactive";
         } else if (!var7) {
            var8 = var8 + ".disabled";
         } else if (var6 || var5) {
