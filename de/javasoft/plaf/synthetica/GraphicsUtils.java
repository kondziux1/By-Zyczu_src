...
public class GraphicsUtils extends SynthGraphicsUtils {
   ...
   public void paintText(SynthContext var1, Graphics var2, String var3, int var4, int var5, int var6) {
      ...
      if (var8 != Region.BUTTON && var8 != Region.TOGGLE_BUTTON) {
         if (var8 == Region.TABBED_PANE_TAB) {
            ...
            int var19 = var16.getSelectedIndex();
            int var11 = SyntheticaLookAndFeel.getClientProperty("Synthetica.tabbedPane.tabIndex", var16, -1);
            Color var22 = var11 >= 0 ? var16.getForegroundAt(var11) : null;
            if (var22 != null && !(var22 instanceof UIResource)) {
               var2.setColor(var22);
            }

            if (var19 != var11 && SyntheticaLookAndFeel.getBoolean("Synthetica.tabbedPane.tab.selected.bold", var16)) {
               int var24 = var2.getFontMetrics().stringWidth(var3);
               var2.setFont(var2.getFont().deriveFont(0));
               int var27 = var2.getFontMetrics().stringWidth(var3);
               var4 += (var24 - var27) / 2;
            }

            if (SyntheticaLookAndFeel.get("Synthetica.TabbedPanePainter", var7) != null) {
               TabbedPanePainter var25 = (TabbedPanePainter)SyntheticaLookAndFeel.get("Synthetica.TabbedPanePainter", var7);
               if (!var25.paintTabbedPaneTabText(var1, var2, var3, var4, var5, var6)) {
                  return;
               }
            }
         } else if (var8 == Region.PROGRESS_BAR) {
            String var17 = (String)SyntheticaLookAndFeel.get("Synthetica.progressBar.textBackground", var7);
            if (var17 != null && var17.length() > 0 && var3 != null && var3.trim().length() > 0) {
               Insets var20 = (Insets)SyntheticaLookAndFeel.get("Synthetica.progressBar.textBackground.insets", var7);
               FontMetrics var23 = var2.getFontMetrics();
               int var26 = var23.getHeight();
               int var28 = var23.stringWidth(var3);
               ImagePainter var29 = new ImagePainter(var2, var4 - 2, var5, var28 + 4, var26, var17, var20, var20, 0, 0);
               var29.draw();
            }
         ...
         } else if ((var8 == Region.MENU || var8 == Region.MENU_ITEM || var8 == Region.CHECK_BOX_MENU_ITEM || var8 == Region.RADIO_BUTTON_MENU_ITEM)
            && !this.getPaintMnemonics()) {
            var6 = -1;
         ...
         if (!SyntheticaLookAndFeel.getBoolean("Button.showMnemonics", var7, true)) {
            var6 = -1;
         }

         String var9 = (String)SyntheticaLookAndFeel.get("Synthetica.button.textBackground", var7);
         if (var9 != null && var9.length() > 0 && var3 != null && var3.trim().length() > 0) {
            Insets var10 = (Insets)SyntheticaLookAndFeel.get("Synthetica.button.textBackground.insets", var7);
            FontMetrics var12 = var2.getFontMetrics();
            int var13 = var12.getHeight();
            int var14 = var12.stringWidth(var3);
            ImagePainter var15 = new ImagePainter(var2, var4 - 2, var5, var14 + 4, var13, var9, var10, var10, 0, 0);
            var15.draw();
         }
      }
      ...
      if (!SyntheticaLookAndFeel.getAntiAliasEnabled() && !SyntheticaLookAndFeel.getBoolean("Synthetica.text.antialias", var7)) {
         ...
         Object var21 = var18.getRenderingHint(RenderingHints.KEY_TEXT_ANTIALIASING);
         if (JavaVersion.JAVA5) {
            var18.setRenderingHint(RenderingHints.KEY_TEXT_ANTIALIASING, RenderingHints.VALUE_TEXT_ANTIALIAS_ON);
         } else {
            var18.setRenderingHint(RenderingHints.KEY_TEXT_ANTIALIASING, RenderingHints.VALUE_TEXT_ANTIALIAS_LCD_HRGB);
         }

         super.paintText(var1, var18, var3, var4, var5, var6);
         var18.setRenderingHint(RenderingHints.KEY_TEXT_ANTIALIASING, var21);
      }
   ...
   protected boolean getPaintMnemonics() {
      return AltKeyEventProcessor.showMnemonicsOnAltKeyOnly() ? AltKeyEventProcessor.isMenuActive() : true;
   }
   ...
   public void drawLine(SynthContext var1, Object var2, Graphics var3, int var4, int var5, int var6, int var7) {
      ...
      if (var2 instanceof String && ((String)var2).startsWith("Tree.")) {
         ...
         if ("SOLID".equals(var10)) {
            ...
            if (var2.equals("Tree.horizontalLine")) {
               for(int var13 = var4; var13 < var6; var13 += var11 + var12) {
                  var3.drawLine(var13, var5, Math.min(var13 + var11 - 1, var6), var7);
               }
            } else {
               for(int var14 = var5; var14 < var7; var14 += var11 + var12) {
                  var3.drawLine(var4, var14, var4, Math.min(var14 + var11 - 1, var7));
               }
            }
         }
         ...
         || !((String)var2).equals("Table.grid")
         || SyntheticaLookAndFeel.getInt("Synthetica.table.columnMargin", var1.getComponent(), 1) != 0) {
         if (var5 != var7
            || !(var2 instanceof String)
            || !((String)var2).equals("Table.grid")
            || SyntheticaLookAndFeel.getInt("Synthetica.table.rowMargin", var1.getComponent(), 1) != 0) {
   ...
   public String layoutText(
      ...
      if (var13 instanceof JTabbedPane) {
         ...
         SynthStyleFactory var14 = SyntheticaLookAndFeel.getStyleFactory();
   ...
   private void tabbedPaneTabCorrection(
      SynthContext var1, JTabbedPane var2, FontMetrics var3, String var4, Icon var5, Rectangle var6, Rectangle var7, Rectangle var8
   ) {
      int var9 = var2.getSelectedIndex();
      int var10 = SyntheticaLookAndFeel.getClientProperty("Synthetica.tabbedPane.tabIndex", var2, -1);
   ...
   protected void paintTextShadow(
      JComponent var1,
      Graphics var2,
      int var3,
      int var4,
      ...
      if (var5 != null && var5.length() != 0) {
         ...
         if (this.getPaintMnemonics() && var14 >= 0 && var14 < var5.length()) {
