...
class SyntheticaInternalFrameTitlePaneLayout5 implements LayoutManager {
   ...
   public SyntheticaInternalFrameTitlePaneLayout5(BasicInternalFrameTitlePane var1) {
      ...
      this.menuButton = (JButton)SyntheticaLookAndFeel.findComponent("InternalFrameTitlePane.menuButton", var1);
      this.iconButton = (JButton)SyntheticaLookAndFeel.findComponent("InternalFrameTitlePane.iconifyButton", var1);
      this.maxButton = (JButton)SyntheticaLookAndFeel.findComponent("InternalFrameTitlePane.maximizeButton", var1);
      this.closeButton = (JButton)SyntheticaLookAndFeel.findComponent("InternalFrameTitlePane.closeButton", var1);
   }
   ...
   public Dimension minimumLayoutSize(Container var1) {
      ...
      Insets var22 = this.titlePane.getInsets();
      var3 += var22.top + var22.bottom;
      var2 += var22.left + var22.right;
   ...
   public void layoutContainer(Container var1) {
      ...
      if (this.frame.getComponentOrientation().isLeftToRight()) {
         ...
         int var3 = this.titlePane.getWidth() - var2.right;
         if (this.frame.isClosable()) {
         ...
         if (this.frame.isIconifiable()) {
            var3 = this.setButtonBounds(this.iconButton, var3, true);
         }
      } else {
         this.setButtonBounds(this.menuButton, this.titlePane.getWidth() - var2.right, true);
         int var5 = var2.left;
         if (this.frame.isClosable()) {
            var5 = this.setButtonBounds(this.closeButton, var5, false);
         }

         if (this.frame.isMaximizable()) {
            var5 = this.setButtonBounds(this.maxButton, var5, false);
         }

         if (this.frame.isIconifiable()) {
            var5 = this.setButtonBounds(this.iconButton, var5, false);
         }
      }
