...
public class SyntheticaMenuItemUI extends BasicMenuItemUI implements PropertyChangeListener, SynthConstants {
   ...
   private void updateStyle(JMenuItem var1) {
      ...
      String var7 = UIManager.getString("MenuItem.acceleratorDelimiter");
      if (var7 == null) {
         var7 = "+";
      }

      this.acceleratorDelimiter = var4.getString(var3, var2 + ".acceleratorDelimiter", var7);
   ...
   protected Dimension getPreferredMenuItemSize(JComponent var1, Icon var2, Icon var3, int var4) {
      ...
      return getPreferredMenuItemSize(var5, var6, false, var1, var2, var3, var4, this.acceleratorDelimiter);
   }
   ...
   static Dimension getPreferredMenuItemSize(SynthContext var0, SynthContext var1, boolean var2, JComponent var3, Icon var4, Icon var5, int var6, String var7) {
      ...
      if (var11 != null) {
         ...
         if (var18 > 0) {
            var12 = KeyEvent.getKeyModifiersText(var18);
            var12 = var12 + var7;
         }
      ...
      Font var26 = var0.getStyle().getFont(var0);
      FontMetrics var27 = var8.getFontMetrics(var26);
      ...
      layoutMenuItem(
         ...
         var4,
         var5,
         var8.getVerticalAlignment(),
         var8.getHorizontalAlignment(),
         var8.getVerticalTextPosition(),
         var8.getHorizontalTextPosition(),
         viewRect,
         iconRect,
         textRect,
         acceleratorRect,
      ...
      if (var13 != null) {
         ...
         if (var21 == null) {
            maxWidths.put(var13, new SyntheticaMenuItemUI.MaxWidth(null));
         ...
         r.width += var21.maxAcceleratorWidth;
         if (var21.maxAcceleratorWidth > 0) {
            r.width += var16;
         }

         r.width += var21.maxIconWidth;
         ...
         if (!var2) {
            if (SyntheticaLookAndFeel.popupHasCheckRadioWithIcon(var13)) {
               r.width += var21.maxCheckIconWidth;
               if (var21.maxCheckIconWidth > 0) {
                  r.width += var14;
               }
            } else if (SyntheticaLookAndFeel.popupHasCheckRadio(var13)) {
               r.width -= var21.maxIconWidth;
               r.width += Math.max(var21.maxIconWidth, var21.maxCheckIconWidth);
               if (var21.maxIconWidth > 0) {
                  r.width -= var15;
               }
            ...
            if (var21.maxAcceleratorWidth == 0) {
               r.width += var21.maxArrowIconWidth;
      ...
      r.width += (var2 ? 0 : var28.left) + var28.right;
      r.width += var2 && var9 != null ? var28.left + var15 : 0;
      r.height += var28.top + var28.bottom;
      int var23 = SyntheticaLookAndFeel.getInt("Menu.menuPopupOffsetX", null, 0);
   ...
   private static String layoutMenuItem(
      ...
      if (var23 != null) {
         ...
         if (var34 == null) {
            maxWidths.put(var23, new SyntheticaMenuItemUI.MaxWidth(null));
      ...
      boolean var41 = var23 == null ? var6 != null : SyntheticaLookAndFeel.preservePopupIconSpace(var23);
      boolean var35 = var23 == null ? var7 != null : SyntheticaLookAndFeel.popupHasCheckRadio(var23);
      boolean var36 = var23 == null ? var35 && var41 : SyntheticaLookAndFeel.popupHasCheckRadioWithIcon(var23);
      var0.getStyle().getGraphicsUtils(var0).layoutText(var0, var1, var3, var6, var10, var9, var12, var11, var13, var14, var15, var26);
      if (!var21) {
         if (var7 != null) {
            var17.width = SynthIcon.getIconWidth(var7, var0);
            var17.height = SynthIcon.getIconHeight(var7, var0);
         } else {
            var17.width = var17.height = 0;
         }

         if (var8 != null) {
            var18.width = SynthIcon.getIconWidth(var8, var0);
            var18.height = SynthIcon.getIconHeight(var8, var0);
         } else {
      ...
      if (var21) {
         Insets var37 = var0.getStyle().getInsets(var0, null);
         if (var24) {
         ...
         int var42 = Math.max(var32, var31);
         if (var24) {
            var17.x = var13.x + var25 + (var42 - var17.width) / 2;
            var14.x = var13.x + var25 + (var42 - var14.width) / 2;
            var15.x = var13.x + var25 + var42 + var25 + var28;
         } else {
            var17.x = var13.x + var13.width - var25 - var32 - (var42 - var17.width) / 2;
            var14.x = var13.x + var13.width - var25 - var31 - (var42 - var14.width) / 2;
            var15.x = var13.x + var13.width - var25 - var42 - var25 - var28 - var15.width;
         }
      } else if (var41 && !var35) {
         if (var24) {
            var14.x = var13.x + var25;
            var15.x = var13.x + var25 + var31 + var26 + var28;
         } else {
      ...
      if (var5 != null && !var5.equals("")) {
         SynthStyle var43 = var2.getStyle();
         var16.width = var43.getGraphicsUtils(var2).computeStringWidth(var2, var4.getFont(), var4, var5);
      ...
      Rectangle var44 = var14.union(var15);
      ...
      var16.y = var44.y + (var44.height / 2 - var16.height / 2);
      if (!var21) {
         var18.y = var44.y + (var44.height / 2 - var18.height / 2);
         var17.y = var44.y + (var44.height / 2 - var17.height / 2);
      }
   ...
   private void paint(SynthContext var1, Graphics var2) {
      ...
      var7 = SyntheticaLookAndFeel.getClientProperty("Synthetica.menuItem.arrowIcon", var3, var7);
      if ((var1.getComponentState() & 2) > 0) {
         var7 = SyntheticaLookAndFeel.getClientProperty("Synthetica.menuItem.hover.arrowIcon", var3, var7);
      }
   ...
   static void paint(SynthContext var0, SynthContext var1, Graphics var2, Icon var3, Icon var4, boolean var5, String var6, int var7) {
      ...
      Insets var12 = var10.getInsets(var0, null);
      ...
      viewRect.y += var12.top;
      viewRect.height += -var12.bottom - var12.top;
      if (!var5) {
         viewRect.x += var14 ? var12.left : var12.right;
         viewRect.width += -var12.right - var12.left;
      }
      ...
      String var24 = layoutMenuItem(
         ...
         var3,
         var4,
         var9.getVerticalAlignment(),
         var9.getHorizontalAlignment(),
         var9.getVerticalTextPosition(),
         var9.getHorizontalTextPosition(),
         viewRect,
         iconRect,
         textRect,
         acceleratorRect,
         checkIconRect,
         arrowIconRect,
         var9.getText() == null ? 0 : var7,
         var7,
         var5
      );
      if (var3 != null && !var5) {
         SynthIcon.paintIcon(var3, var0, var2, checkIconRect.x, checkIconRect.y, checkIconRect.width, checkIconRect.height);
      }
      ...
      if (var9.getIcon() != null) {
         Icon var25;
         if (!var11.isEnabled()) {
            var25 = var9.getDisabledIcon();
         } else if (var11.isPressed() && var11.isArmed()) {
            var25 = var9.getPressedIcon();
            if (var25 == null) {
               var25 = var9.getIcon();
            }
         } else {
         ...
         if (var25 != null) {
            SynthIcon.paintIcon(var25, var0, var2, iconRect.x, iconRect.y, iconRect.width, iconRect.height);
         }
      }

      if (var24 != null) {
         View var26 = (View)var8.getClientProperty("html");
         if (var26 != null) {
            var26.paint(var2, textRect);
         } else {
            var2.setColor(var10.getColor(var0, ColorType.TEXT_FOREGROUND));
            var2.setFont(var10.getFont(var0));
            var10.getGraphicsUtils(var0).paintText(var0, var2, var24, textRect.x, textRect.y, var9.getDisplayedMnemonicIndex());
         }
      }
      ...
      if (var19 != null && !var19.equals("")) {
         ...
         var22.getGraphicsUtils(var1).paintText(var1, var2, var19, acceleratorRect.x - var27, acceleratorRect.y, -1);
      }

      if (var4 != null && !var5) {
         SynthIcon.paintIcon(var4, var0, var2, arrowIconRect.x, arrowIconRect.y, arrowIconRect.width, arrowIconRect.height);
      }
