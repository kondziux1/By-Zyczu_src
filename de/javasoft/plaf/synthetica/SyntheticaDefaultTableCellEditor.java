...
public class SyntheticaDefaultTableCellEditor extends DefaultCellEditor {
   ...
   public SyntheticaDefaultTableCellEditor(JTextField var1, Boolean var2) {
      ...
      this.respectNumberLocale = var2 != null ? var2 : SyntheticaLookAndFeel.getBoolean("Synthetica.table.cellEditor.respectNumberLocale", null, false);
   }
   ...
   protected Border createErrorCellFocusBorder(JTable var1) {
      return new SyntheticaDefaultTableCellEditor.CellFocusBorder(
         SyntheticaLookAndFeel.getColor("Synthetica.table.cellEditor.focus.errorColor", var1, new Color(15138816))
      );
   }
   ...
   public static class CellFocusBorder implements Border {
      ...
      public Insets getBorderInsets(Component var1) {
         ...
         if (var1.getParent() instanceof JTable) {
            ...
            SynthStyle var4 = SyntheticaLookAndFeel.getStyleFactory().getStyle(var3, Region.LABEL);
            return var4.getInsets(new SynthContext(var3, Region.LABEL, var4, 0), null);
         } else {
