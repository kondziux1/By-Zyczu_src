...
public class SyntheticaComboBoxLayoutManager implements LayoutManager2 {
   ...
   public SyntheticaComboBoxLayoutManager() {
      super();
   }
   ...
   private void layoutComboBox(Container var1) {
      ...
      if (var3 != null) {
         ...
         Insets var5 = var3.getInsets();
         int var6 = var3.getPreferredSize().width + var5.left + var5.right;
         int var7 = SyntheticaLookAndFeel.getInt("Synthetica.comboBox.button.xOffset", var2, 0);
         if (SyntheticaLookAndFeel.getClientProperty("JComboBox.isTableCellEditor", var2, false) && !"JFileChooser.DirectoryComboBox".equals(var2.getName())) {
            var7 = SyntheticaLookAndFeel.getInt("Synthetica.comboBox.button.tableCellEditor.xOffset", var2, 0);
         }

         var3.setBounds(
            var2.getComponentOrientation().isLeftToRight() ? var2.getWidth() - var4.right - var6 + var7 : var4.left - var7,
            var4.top,
            var6,
            var2.getHeight() - var4.top - var4.bottom
         );
      }

      ComboBoxEditor var10 = var2.getEditor();
      if (var10 != null) {
         Insets var11 = var2.getInsets();
         Object var12 = null;
         int var14 = var2.getWidth();
         int var8 = var2.getHeight();
         int var9 = var3 == null ? var8 - (var11.top + var11.bottom) : var3.getWidth();
         Rectangle var13;
         if (var2.getComponentOrientation().isLeftToRight()) {
            var13 = new Rectangle(var11.left, var11.top, var14 - (var11.left + var11.right + var9), var8 - (var11.top + var11.bottom));
         } else {
            var13 = new Rectangle(var11.left + var9, var11.top, var14 - (var11.left + var11.right + var9), var8 - (var11.top + var11.bottom));
         }

         var10.getEditorComponent().setBounds(var13);
      }
