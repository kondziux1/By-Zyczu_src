...
public class InternalFramePainter extends SyntheticaComponentPainter {
   ...
   public static InternalFramePainter getInstance(SynthContext var0) {
      SyntheticaComponentPainter var1 = (SyntheticaComponentPainter)instances.get(
         getPainterClassName(var0, InternalFramePainter.class, "Synthetica.InternalFramePainter")
      );
      if (var1 == null) {
   ...
   public void paintInternalFrameTitlePaneBackground(SynthContext var1, Graphics var2, int var3, int var4, int var5, int var6) {
      ...
      Insets var19 = SyntheticaLookAndFeel.getInsets("Synthetica.internalFrameTitlePane.background.insets", var7);
      byte var20 = 0;
      ...
      if (var15 != null) {
         ImagePainter var14 = new ImagePainter(var2, var3, var4, var5, var6, var15, var19, var19, var20, var13);
         var14.draw();
      }
      ...
      var15 = SyntheticaLookAndFeel.getString(var15, var7);
      if (var15 != null) {
         ImagePainter var21 = new ImagePainter(var2, var3, var4, var5, var6, var15, var19, var19, 0, var13);
         var21.draw();
      }
   ...
   protected void paintTitle(SynthContext var1, Graphics var2, int var3) {
      ...
      var6 = var1.getStyle()
         ...
         .layoutText(var1, var2.getFontMetrics(), var6, null, 0, 0, 0, 0, var18, new Rectangle(0, 0), new Rectangle(0, 0), 0);
      if (SyntheticaLookAndFeel.getBoolean("Synthetica.internalFrame.titlePane.dropShadow", var4) && var5 && var9 > 0 && var8 > 0) {
         ...
         if (SyntheticaLookAndFeel.get("Synthetica.internalFrame.titlePane.dropShadow.highQuality", var4) != null) {
      ...
      Color var28 = var4.getForeground();
      Color var29 = var28 != null && !(var28 instanceof ColorUIResource) ? var28 : var1.getStyle().getColor(var1, ColorType.FOREGROUND);
      SynthStyle var30 = var1.getStyle();
      if (var4.getParent() instanceof JInternalFrame) {
         JInternalFrame var22 = (JInternalFrame)var4.getParent();
         var30 = SynthLookAndFeel.getStyle(var22, Region.INTERNAL_FRAME_TITLE_PANE);
         var1 = new SynthContext(var22, Region.INTERNAL_FRAME_TITLE_PANE, var30, var1.getComponentState());
      }

      if (SyntheticaLookAndFeel.getBoolean("Synthetica.internalFrame.titlePane.title.etchedTop", var4)) {
         var2.setColor(Color.BLACK);
         var30.getGraphicsUtils(var1).paintText(var1, var2, var6, var17, var10 - 1, -2);
      }
      ...
      var2.setColor(var29);
      var30.getGraphicsUtils(var1).paintText(var1, var2, var6, var17, var10, -2);
   }
   ...
   private void setIcons(BasicInternalFrameTitlePane var1, SynthContext var2) {
      ...
      if (!var6
         || (!var5.endsWith("maximizeButton") || !(var10 instanceof JInternalFrame)) && (!var5.endsWith("iconifyButton") || !(var10 instanceof JDesktopIcon))) {
      ...
      if (var10 instanceof JInternalFrame) {
         JInternalFrame var26 = (JInternalFrame)var10;
         if (var26.isMaximum()) {
            if (var16 != null) {
               var16.setIcon(var12);
            }
   ...
   protected Rectangle getControlButtonsBounds(BasicInternalFrameTitlePane var1) {
      ...
      if ((var10 == null || !var10.isIconifiable()) && (var10 != null || var2 == null)) {
         if (var10 != null && var10.isMaximizable() || var10 == null && var3 != null) {
            Rectangle var13 = var3.getBounds();
            if (var5) {
               var11.width = var13.x + var13.width - var11.x;
            } else {
               var11.width = var11.x + var11.width - var13.x;
               var11.x = var13.x;
            }
         }
      } else {
   ...
   protected Rectangle getMenuButtonBounds(BasicInternalFrameTitlePane var1) {
      JButton var2 = (JButton)SyntheticaLookAndFeel.findComponent("InternalFrameTitlePane.menuButton", var1);
   ...
   public Cacheable.ScaleType getCacheScaleType(String var1) {
      return !var1.equals("paintInternalFrameBorder") && !var1.equals("paintInternalFrameBackground")
