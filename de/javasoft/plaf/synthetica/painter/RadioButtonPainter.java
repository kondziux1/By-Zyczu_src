...
public class RadioButtonPainter extends SyntheticaComponentPainter {
   ...
   public static RadioButtonPainter getInstance(SynthContext var0) {
      SyntheticaComponentPainter var1 = (SyntheticaComponentPainter)instances.get(
         getPainterClassName(var0, RadioButtonPainter.class, "Synthetica.RadioButtonPainter")
      );
      if (var1 == null) {
   ...
   public void paintRadioButtonBackground(SynthContext var1, Graphics var2, int var3, int var4, int var5, int var6) {
      ...
      if (SyntheticaLookAndFeel.get("Synthetica.radioButton.image", var7) != null && var7.getIcon() == null) {
         ...
         if (var7.hasFocus() && SyntheticaLookAndFeel.get(var9.get() + ".focused.image", var7) != null) {
         ...
         ImagePainter var21 = new ImagePainter(
            var7, var14, var15, var16, var8.getState(), var2, var19.x, var19.y, var19.width, var19.height, var13, var10, var10, 0, 0
         );
         if (!var8.isSet(SyntheticaState.State.PRESSED) || var7.getPressedIcon() == null) {
            var21.drawCenter();
         }

         if (var8.isSet(SyntheticaState.State.FOCUSED) && var7.isFocusPainted() && SyntheticaLookAndFeel.get("Synthetica.radioButton.focus", var7) != null) {
      ...
      if (var8.isSet(SyntheticaState.State.FOCUSED) && var7.isFocusPainted()) {
         ...
         boolean var28 = var7.getClientProperty("html") != null;
         if (!var28) {
            FontMetrics var30 = var7.getFontMetrics(var7.getFont());
            if (var25 != null) {
               var26 += var30.stringWidth(var25);
            }
         } else {
