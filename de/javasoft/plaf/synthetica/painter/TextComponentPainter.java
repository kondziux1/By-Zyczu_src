...
class TextComponentPainter extends SyntheticaComponentPainter {
   ...
   protected void paintBackground(String var1, SynthContext var2, Graphics var3, int var4, int var5, int var6, int var7) {
      ...
      if (var13 && (!var16 || !var15)) {
         ...
         Boolean var19 = (Boolean)SyntheticaLookAndFeel.get(var18.get("fillBackground"), var8);
         ...
         if (var10 || !var12) {
            if (var10 || var11 || !var16) {
               SyntheticaState var32 = new SyntheticaState(var17.getState());
               if (!var10 && !var11) {
                  var32.resetState(SyntheticaState.State.LOCKED);
               }

               var18 = new UIKey(var1 + ".border", var32);
               boolean var33 = SyntheticaLookAndFeel.get(var18.get(), var8) != null;
               if (var14 && !var33) {
                  var32.resetState(SyntheticaState.State.LOCKED);
                  var18 = new UIKey(var1 + ".border", var32);
               }

               String var26 = (String)var18.findProperty(var2, null, false, 1);
               if (var8.hasFocus() && SyntheticaLookAndFeel.get(var18.get() + ".focused", var8) != null) {
               ...
               Insets var28 = SyntheticaLookAndFeel.get("Synthetica." + var1 + ".border.dInsets", var8) == null
                  ? var27
                  : SyntheticaLookAndFeel.getInsets("Synthetica." + var1 + ".border.dInsets", var8);
   ...
   protected void paintBorder(String var1, SynthContext var2, Graphics var3, int var4, int var5, int var6, int var7) {
      ...
      if (!(var8 instanceof JTextComponent)) {
         UIKey var9 = new UIKey(var1 + ".border", new SyntheticaState());
         String var10 = (String)var9.findProperty(var2, null, true, 1);
         Insets var11 = SyntheticaLookAndFeel.getInsets("Synthetica." + var1 + ".border.insets", var8);
         Insets var12 = SyntheticaLookAndFeel.get("Synthetica." + var1 + ".border.dInsets", var8) == null
            ? var11
            : SyntheticaLookAndFeel.getInsets("Synthetica." + var1 + ".border.dInsets", var8);
