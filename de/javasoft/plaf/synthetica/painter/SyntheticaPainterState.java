...
class SyntheticaPainterState extends SyntheticaState {
   ...
   public SyntheticaPainterState(SynthContext var1, int var2, boolean var3, boolean var4) {
      ...
      if (var3) {
         boolean var6 = var5.getClientProperty("Synthetica.MOUSE_OVER") == null ? false : var5.getClientProperty("Synthetica.MOUSE_OVER");
         if (var6) {
            this.setState(SyntheticaState.State.HOVER);
         }

         boolean var7 = var5.getClientProperty("Synthetica.MOUSE_PRESSED") == null ? false : var5.getClientProperty("Synthetica.MOUSE_PRESSED");
         if (var7) {
      ...
      if (var4) {
         ...
         if (var9 instanceof JComponent) {
            boolean var10 = ((JComponent)var9).getClientProperty("Synthetica.MOUSE_OVER") == null
               ? false
               : ((JComponent)var9).getClientProperty("Synthetica.MOUSE_OVER");
            if (var10) {
               this.setState(SyntheticaState.State.HOVER);
            }

            boolean var8 = ((JComponent)var9).getClientProperty("Synthetica.MOUSE_PRESSED") == null
               ? false
               : ((JComponent)var9).getClientProperty("Synthetica.MOUSE_PRESSED");
            if (var8) {
               this.setState(SyntheticaState.State.PRESSED);
            }
         }
