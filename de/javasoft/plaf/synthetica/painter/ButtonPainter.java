...
public class ButtonPainter extends SyntheticaComponentPainter {
   ...
   public void paintButtonBackground(JComponent var1, SyntheticaState var2, String var3, int var4, Graphics var5, int var6, int var7, int var8, int var9) {
      if (this.paintCheck(var1, var2)) {
         ...
         String var10 = var3 != null && var3.length() != 0 ? "." + var3 : "";
         ...
         Container var12 = var1.getParent();
         Insets var13 = (Insets)UIKey.findProperty(var1, var11.get(), "insets", true, 2);
         if (this.isToolBarButton(var1) && !SyntheticaLookAndFeel.getBoolean("Synthetica.toolBar.buttons.paintBorder", var1)) {
            ...
            if (SyntheticaLookAndFeel.get(var11.get(), var1) == null) {
               var11 = new UIKey("toolBar.button.border", var2);
            }
         } else if (var12 != null && var12.getParent() instanceof JToolBar && "ButtonBar".equals(SyntheticaLookAndFeel.getStyleName(var12))) {
            UIKey var15 = new UIKey("toolBar.buttonBar.button.border" + var10, var2);
            if (SyntheticaLookAndFeel.get(var15.get(), var1) != null) {
               var11 = var15;
            }
         }

         String var22 = SyntheticaLookAndFeel.getString(var11.get(), var1);
         if (var1.hasFocus() && SyntheticaLookAndFeel.get(var11.get() + ".focused", var1) != null) {
            var22 = SyntheticaLookAndFeel.getString(var11.get() + ".focused", var1);
         }

         var11 = new UIKey("button", var2);
         if (var22 != null && SyntheticaLookAndFeel.isOpaque(var1)) {
            ...
            ImagePainter var19 = new ImagePainter(var1, var16, var17, var18, var2.getState(), var5, var6, var7, var8, var9, var22, var13, var13, 0, 0);
            var19.setAngle(var4);
            var19.draw();
         }

         if ((var1.hasFocus() || var2.isSet(SyntheticaState.State.FOCUSED)) && ((AbstractButton)var1).isFocusPainted()) {
            var10 = var10 != null && var10.length() != 0 ? var10 : "";
            FocusPainter.paintFocus("focus.button" + var10, var1, var2.getState(), null, var4, var5, var6, var7, var8, var9);
         }
   ...
   protected boolean paintCheck(JComponent var1, SyntheticaState var2) {
      if (!(var1 instanceof AbstractButton)) {
         ...
         if (var4 != null) {
            if (var4 instanceof BasicInternalFrameTitlePane
               && !SyntheticaLookAndFeel.getBoolean("Synthetica.internalFrame.titlePane.buttons.paintBorder", var3)) {
               return false;
            }
            ...
            if (this.isToolBarButton(var1)) {
               ...
               if ((var8.equals(var7) || !buttons.containsKey(var3) && (var3.getText() == null || "".equals(var3.getText().trim()))) && var8.equals(var7)) {
                  var3.setMargin(new Insets(var8.bottom - var7.bottom, var8.left - var7.left, var8.top - var7.top, var8.right - var7.right));
               }

               buttons.put(var3, null);
               ...
               if (!var9
                  ...
                  && SyntheticaLookAndFeel.get("Synthetica.toolBar.button.border", var3) == null
                  && (!var2.isSet(SyntheticaState.State.PRESSED) || !SyntheticaLookAndFeel.getBoolean("Synthetica.toolBar.button.pressed.paintBorder", var3))) {
                  return false;
               }
            }
         }
   ...
   public int getCacheHash(SynthContext var1, int var2, int var3, int var4, String var5) {
      ...
      if (var6.getParent() instanceof JToolBar) {
         ...
         return 31 * var9 + (var6.isContentAreaFilled() ? 0 : 1);
      }
   }
}
