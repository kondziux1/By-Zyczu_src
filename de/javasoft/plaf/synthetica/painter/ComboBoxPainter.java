...
public class ComboBoxPainter extends SyntheticaComponentPainter {
   ...
   public static ComboBoxPainter getInstance(SynthContext var0) {
      SyntheticaComponentPainter var1 = (SyntheticaComponentPainter)instances.get(
         getPainterClassName(var0, ComboBoxPainter.class, "Synthetica.ComboBoxPainter")
      );
      if (var1 == null) {
   ...
   public void paintComboBoxBackground(SynthContext var1, Graphics var2, int var3, int var4, int var5, int var6) {
      ...
      if (var12) {
         ...
         UIKey var16 = new UIKey("comboBox", var15);
         Boolean var17 = (Boolean)SyntheticaLookAndFeel.get(var16.get("fillBackground"), var7);
         ...
         if (var9 || !var11) {
            SyntheticaState var31 = new SyntheticaState(var15.getState());
            var31.resetState(SyntheticaState.State.HOVER);
            var31.resetState(SyntheticaState.State.PRESSED);
            if (!var9 && !var10) {
               var31.resetState(SyntheticaState.State.LOCKED);
            }

            var16 = new UIKey("comboBox.border", var31);
            String var32 = var16.get();
            boolean var24 = SyntheticaLookAndFeel.get(var32, var7) != null;
            if (var32.equals("Synthetica.comboBox.border.disabled") && !var24
               || var32.equals("Synthetica.comboBox.border.locked") && !var24
               || var32.equals("Synthetica.comboBox.border.disabled.locked") && !var24) {
               var16 = new UIKey("textField.border", var31);
            }

            String var25 = (String)var16.findProperty(var1, null, true, 1);
            if (var15.isSet(SyntheticaState.State.FOCUSED) && SyntheticaLookAndFeel.get(var16.get() + ".focused", var7) != null) {
               var25 = SyntheticaLookAndFeel.getString(var16.get() + ".focused", var7);
            }

            if (var7.isPopupVisible() && SyntheticaLookAndFeel.get(var16.get() + ".opened", var7) != null) {
               var25 = SyntheticaLookAndFeel.getString(var16.get() + ".opened", var7);
               BasicComboPopup var26 = null;

               try {
                  ComboBoxUI var27 = var7.getUI();
                  Method var36 = var27.getClass().getDeclaredMethod("getPopup", null);
                  var26 = (BasicComboPopup)var36.invoke(var27, null);
               ...
               Boolean var34 = var26 == null ? true : MenuPainter.popupIsBelowInvoker(var7, var26);
               if ((var34 == null || !var34) && SyntheticaLookAndFeel.get(var16.get() + ".openedAndPopupNotBelow", var7) != null) {
                  var25 = SyntheticaLookAndFeel.getString(var16.get() + ".openedAndPopupNotBelow", var7);
               }
            }

            Insets var33 = SyntheticaLookAndFeel.getInsets("Synthetica.comboBox.border.insets", var7);
            Insets var35 = SyntheticaLookAndFeel.get("Synthetica.comboBox.border.dInsets", var7) == null
               ? var33
               : SyntheticaLookAndFeel.getInsets("Synthetica.comboBox.border.dInsets", var7);
            if (!var20) {
               Insets var37 = var7.getInsets();
               var3 += var37.left;
               var4 += var37.top;
               var5 += -var37.left - var37.right;
               var6 += -var37.top - var37.bottom;
               var35 = new Insets(0, 0, 0, 0);
            }

            ImagePainter var38 = new ImagePainter(var7, var2, var3, var4, var5, var6, var25, var33, var35, 0, 0);
            if (!var9 && !var10) {
               var38.drawBorder();
            } else if (!var20) {
               var38.drawCenter();
            ...
            if (SyntheticaLookAndFeel.getBoolean("Synthetica.comboBox.hoverAndPressed.enabled", var7)) {
               this.paintHoverPressed(var7, var15, var18, var19, var21, var2, var3, var4, var5, var6, var33, var35);
            }
   ...
   private SyntheticaPainterState createState(SynthContext var1, JComboBox var2) {
      byte var3 = 0;
      JButton var4 = (JButton)SyntheticaLookAndFeel.findComponent(JButton.class, var2);
   ...
   private void paintHoverPressed(
      JComboBox var1,
      SyntheticaPainterState var2,
      Border var3,
      Border var4,
      boolean var5,
      Graphics var6,
      ...
      if (SyntheticaLookAndFeel.getBoolean("Synthetica.comboBox.stateChange4ButtonOnly", var1)) {
         ...
         int var14 = SyntheticaLookAndFeel.findComponent(JButton.class, var1).getWidth();
         Insets var15 = var5 ? var4.getBorderInsets(var1) : var1.getInsets();
         int var16 = SyntheticaLookAndFeel.getInt("Synthetica.comboBox.button.relativeX", var1, 0);
         if (var4 != null) {
      ...
      UIKey var20 = new UIKey("comboBox", var2);
      UIKey var21 = new UIKey("comboBox.border", var2);
      String var22 = (String)UIKey.findProperty(var1, var21.get(), null, true, 1);
      int var23 = SyntheticaLookAndFeel.getInt(var20.get("animation.cycles"), var1, 1);
      ...
      ImagePainter var19 = new ImagePainter(var1, var23, var17, var18, var2.getState(), var6, var7, var8, var9, var10, var22, var11, var12, 0, 0);
      if (var4 == null) {
         var19.drawCenter();
      } else {
         var19.draw();
   ...
   public int getCacheHash(SynthContext var1, int var2, int var3, int var4, String var5) {
      ...
      if (var6 instanceof JComboBox) {
         ...
         boolean var10 = var8.getClientProperty("Synthetica.MOUSE_OVER") == null ? false : var8.getClientProperty("Synthetica.MOUSE_OVER");
