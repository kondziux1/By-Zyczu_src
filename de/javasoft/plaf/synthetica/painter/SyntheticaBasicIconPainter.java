...
public class SyntheticaBasicIconPainter extends SyntheticaIconPainter implements Cacheable {
   ...
   private void paintIcon_(SynthContext var1, Graphics var2, int var3, int var4, int var5, int var6) {
      ...
      if (OS.getCurrentOS() == OS.Mac && OS_X_QUARTZ_ENABLED) {
         var14.translate(
            (double)((long)var3 + Math.round((double)(this.getScale() / 2.0F) - 0.5)),
            (double)((long)var4 + Math.round((double)(this.getScale() / 2.0F) - 0.5))
         );
      } else {
   ...
   private boolean paintCachedImage(SynthContext var1, Graphics var2, int var3, int var4, int var5, int var6) {
      int var7 = 0;
      if (var1 != null
         && UIManager.getBoolean("Synthetica.cache.enabled")
         && (var7 = this.getCacheHash(var1, var5, var6, 0, "")) != -1
         && SyntheticaSoftCache.getInstance().isCacheable(var5, var6)) {
         VolatileImage var8 = this.getCachedImage(var7, var1, var2, var5, var6);
         return var8 == null ? false : var2.drawImage(var8, var3, var4, null);
      } else {
         return false;
      }
   }
   ...
   protected Color getSyntheticaBackgroundColor(JComponent var1) {
      ...
      if (var2 != null) {
         float var3 = var1.getClientProperty("Synthetica.background.alpha") == null ? 0.1F : var1.getClientProperty("Synthetica.background.alpha");
