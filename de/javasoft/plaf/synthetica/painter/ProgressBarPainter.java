...
public class ProgressBarPainter extends SyntheticaComponentPainter {
   ...
   public static ProgressBarPainter getInstance(SynthContext var0) {
      SyntheticaComponentPainter var1 = (SyntheticaComponentPainter)instances.get(
         getPainterClassName(var0, ProgressBarPainter.class, "Synthetica.ProgressBarPainter")
      );
      if (var1 == null) {
   ...
   public void paintProgressBarBackground(SynthContext var1, Graphics var2, int var3, int var4, int var5, int var6) {
      ...
      String var15 = (String)var12.findProperty(var1, null, true, 1);
   ...
   public void paintProgressBarForeground(SynthContext var1, Graphics var2, int var3, int var4, int var5, int var6, int var7) {
      ...
      if (var7 == 0) {
         int var15 = var14 ? var12.left + var12.right : 1;
         if (var5 < var15) {
            return;
         }
      } else {
         int var30 = var14 ? var12.top + var12.bottom : 1;
         if (var6 < var30) {
            return;
         }
      }
      ...
      String var18 = (String)var11.findProperty(var1, null, true, 2);
      if (!SyntheticaLookAndFeel.getBoolean("Synthetica.progressBar.continuous", var9)) {
         ...
         int var20 = var19.getWidth(null) - var12.left - var12.right;
         int var21 = var19.getHeight(null) - var12.top - var12.bottom;
         var31 = (var5 - var12.left - var12.right) / var20 * var20 + var12.left + var12.right;
         var16 = (var6 - var12.top - var12.bottom) / var21 * var21 + var12.top + var12.bottom;
         var17 = 1;
      }

      int var32 = SyntheticaLookAndFeel.getInt(var11.get("animation.cycles"), var9, -1);
      int var33 = SyntheticaLookAndFeel.getInt(var11.get("animation.delay"), var9, 70);
      int var34 = SyntheticaLookAndFeel.getInt(var11.get("animation.type"), var9, 0);
      ...
      if (var7 == 0) {
         var23 = new ImagePainter(var9, var32, var33, var34, var10.getState(), var2, var3, var4, var31, var6, var18, var12, var12, var17, 0);
         var23.draw();
      } else {
         var23 = new ImagePainter(var9, var32, var33, var34, var10.getState(), var2, var3, var4 - var16 + var6, var5, var16, var18, var12, var12, 0, var17);
         var23.draw();
      }
