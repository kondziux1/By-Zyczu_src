...
public class ArrowButtonPainter extends SyntheticaComponentPainter {
   ...
   public static ArrowButtonPainter getInstance(SynthContext var0) {
      SyntheticaComponentPainter var1 = (SyntheticaComponentPainter)instances.get(
         getPainterClassName(var0, ArrowButtonPainter.class, "Synthetica.ArrowButtonPainter")
      );
      if (var1 == null) {
   ...
   public void paintArrowButtonBackground(SynthContext var1, Graphics var2, int var3, int var4, int var5, int var6) {
      ...
      if (var9 == null || !var9.startsWith("SplitPaneDivider.")) {
         int var12 = var7.getClientProperty("__arrow_direction__");
         boolean var13 = true;
         ...
         if (!(var8 instanceof JComboBox) && (var9 == null || !var9.startsWith("ComboBox.arrowButton"))) {
            if (var8 instanceof JSpinner || "Spinner.nextButton".equals(var9) || "Spinner.previousButton".equals(var9)) {
         ...
         String var17 = (String)var16.findProperty(var1, null, true, 1);
         ...
         ImagePainter var22 = new ImagePainter(
            var7, null, var19, var20, var21, var11.getState(), var2, var3, var4, var5, var6, var17, var15, var15, 0, 0, var14, false
         );
         var22.draw();
      }
   }
   ...
   public void paintArrowButtonForeground(SynthContext var1, Graphics var2, int var3, int var4, int var5, int var6, int var7) {
      ...
      var3 += var8.getClientProperty("Synthetica.arrow.xOffset") == null ? 0 : var8.getClientProperty("Synthetica.arrow.xOffset");
      var4 += var8.getClientProperty("Synthetica.arrow.yOffset") == null ? 0 : var8.getClientProperty("Synthetica.arrow.yOffset");
      ...
      if (var14 != null) {
         ImagePainter var15 = new ImagePainter(var8, null, -1, -1, -1, -1, var2, var3, var4, var5, var6, var14, var12, var13, 0, 0, var11, false);
         var15.draw();
      }
