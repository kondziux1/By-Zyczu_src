...
public class SpinnerPainter extends SyntheticaComponentPainter {
   ...
   public void paintSpinnerBackground(SynthContext var1, Graphics var2, int var3, int var4, int var5, int var6) {
      ...
      if (var11) {
         ...
         Boolean var14 = (Boolean)SyntheticaLookAndFeel.get(var13.get("fillBackground"), var7);
         ...
         if (var9 || !var10) {
            SyntheticaState var26 = new SyntheticaState(var12.getState());
            var26.resetState(SyntheticaState.State.HOVER);
            var26.resetState(SyntheticaState.State.PRESSED);
            var13 = new UIKey("spinner.border", var26);
            String var27 = var13.get();
            boolean var20 = SyntheticaLookAndFeel.get(var27, var7) != null;
            if (var27.equals("Synthetica.spinner.border.disabled") && !var20) {
               var13 = new UIKey("textField.border", var26);
            }

            String var21 = (String)var13.findProperty(var1, null, true, 1);
            if (this.hasFocus(var7) && SyntheticaLookAndFeel.get(var13.get() + ".focused", var7) != null) {
            ...
            Insets var23 = SyntheticaLookAndFeel.get("Synthetica.spinner.border.dInsets", var7) == null
               ? var22
               : SyntheticaLookAndFeel.getInsets("Synthetica.spinner.border.dInsets", var7);
            if (var16 == null) {
            ...
            ImagePainter var28 = new ImagePainter(var7, var2, var3, var4, var5, var6, var21, var22, var23, 0, 0);
            if (!var9) {
               var28.drawBorder();
            } else if (var16 == null) {
               var28.drawCenter();
   ...
   private void paintHoverPressed(
      ...
      if (SyntheticaLookAndFeel.getBoolean("Synthetica.spinner.stateChange4ButtonOnly", var1)) {
         ...
         int var14 = SyntheticaLookAndFeel.findComponent("Spinner.nextButton", var1).getWidth();
      ...
      if (SyntheticaLookAndFeel.getBoolean("Synthetica.spinner.stateChange4SingleButton", var1)) {
         JButton var22 = (JButton)SyntheticaLookAndFeel.findComponent("Spinner.nextButton", var1);
         ...
         var22 = (JButton)SyntheticaLookAndFeel.findComponent("Spinner.previousButton", var1);
         if (var22.getModel().isPressed() || var22.getModel().isRollover()) {
      ...
      UIKey var24 = new UIKey(var21, var2);
      String var25 = (String)UIKey.findProperty(var1, var24.get(), null, true, 1);
      UIKey var26 = new UIKey("spinner", var2);
      int var17 = SyntheticaLookAndFeel.getInt(var26.get("animation.cycles"), var1, 1);
      int var18 = SyntheticaLookAndFeel.getInt(var26.get("animation.delay"), var1, 50);
      int var19 = SyntheticaLookAndFeel.getInt(var26.get("animation.type"), var1, 2);
      if (var2.isSet(SyntheticaState.State.HOVER) || var2.isSet(SyntheticaState.State.PRESSED)) {
         var19 = SyntheticaLookAndFeel.getInt(var26.get("animation.type"), var1, 1);
      }

      ImagePainter var20 = new ImagePainter(var1, var17, var18, var19, var2.getState(), var6, var7, var8, var9, var10, var25, var11, var12, 0, 0);
      if (var4 == null) {
         var20.drawCenter();
      } else {
         var20.draw();
   ...
   protected boolean hasFocus(JComponent var1) {
      if (var1.isEnabled() && var1.isFocusable()) {
         Component var2 = SyntheticaLookAndFeel.findComponent("Spinner.formattedTextField", var1);
   ...
   public int getCacheHash(SynthContext var1, int var2, int var3, int var4, String var5) {
      ...
      return var7 * 31 + (this.hasFocus(var6) ? 0 : 1);
   }
}
